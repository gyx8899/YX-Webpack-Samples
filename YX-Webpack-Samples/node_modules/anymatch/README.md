...
anymatch('node_modules', index1.js'); // false
anymatch('node_modules/**',index1.jss'); // true
anymatch('node_modules/**'index1.jsjs'); // false
anymatch('**/node_modules/**index1.js.js'); // true
```
